...
function ProjectComponentGame(){
    return(
    <div className=' p-5'>
        <h2 className='font-mono text-5xl leading-12 text-center' > Juego Reino Cenfotecos</h2>
        <div className="flex flex-row justify-center px-10 pb-10">
            <div className=' w-1/2  pl-10'>
                <div>
                    <h3 className='font-mono text-3xl leading-11'>Descripción</h3>
                    <p className='font-mono text-xl pb-5'>Este juego fue creado para aplicar diversos patrones de la programación, dentro de los cuales se incluyen: </p>
