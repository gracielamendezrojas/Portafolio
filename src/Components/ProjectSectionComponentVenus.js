...
function ProjectComponentVenus(){
    ...
    <div className='bg-light-gray-brand p-5'>
        <h2 className='font-mono text-5xl leading-12 text-center' >Proyecto Venus</h2>
        <div className="flex flex-row justify-center bg-light-gray-brand pl-20 pr-20 pb-20">
            ...
            <div className=' w-1/2  pl-10'>
                <div>
                    ...
                    <p className='font-mono text-xl pb-5'>Este proyecto ofrece a las usuarias la posibilidad de monitorear su ciclo femenino. Algunas de las funcionalidades de este proyecto web son: </p>
